    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul class="nav-content collapse" id="master-nav" data-bs-parent="#sidebar-nav">
                <a href="?page=admin" aria-current="page" class="nav-link nav-pills">
                ...
                <a href="?page=karyawan" aria-current="page" class="nav-link">
                    <i class="fa fa-circle fa-1x"></i>
                    <span>Master Karyawan</span>
                </a>
                <a href="?page=keterangan" aria-current="page" class="nav-link">
                    <i class="fa fa-circle fa-1x"></i>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" aria-current="page"
                href="?aksi=ubah-admin&username=<?php echo $_SESSION['username']?>"
