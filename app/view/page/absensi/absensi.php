...
<html lang="en">
    ...
    <body>
        ...
        <div class="panel container panel-default bg-body-secondary">
            <h4 class="panel-heading">Absensi Karyawan</h4>
        ...
        <div class="card container mb-4">
            <div class="card-header py-2">
                <h4 class="card-title">Absensi Karyawan
                    <div class="text-end display-4 fs-5"><?php echo $_SESSION['name'] ?></div>
                </h4>
                <a href="?page=absensi" hidden aria-current="page" class="btn btn-info">
                        ...
                        <form action="?aksi=simpan-absensi" method="post">
                            <?php 
                                if(isset($_SESSION['name'])){
                                    $sql = "SELECT * FROM karyawan WHERE nama = '$_SESSION[name]'";
                                    ...
                                    <div class="card-body">
                                        <div class="card-header card-title border border-0">
                                            <div class="text-center display-4 fs-5">
                                                <?php echo ucfirst(ucwords($_SESSION['name'])) ?>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form- row justify-content-center align-items-center">
                                                ...
                                                <div class="col-sm-6 col-md-7">
                                                    <input type="text" name="nip" class="form-control" required readonly
                                                        aria-required="TRUE" value="<?php echo $pro['nip']?>" id="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-inline mt-1">
                                            ...
                                            <div class="form- row justify-content-center align-items-center">
                                                ...
                                                <div class="col-sm-6 col-md-7">
                                                    <input type="date" name="tanggal" class="form-control" required
                                                        readonly aria-required="TRUE" value="<?php echo date('Y-m-d')?>"
                                                        id="">
                                                </div>
                                            </div>
                                        </div>
