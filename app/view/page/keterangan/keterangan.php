...
<html lang="en">
    ...
    <body>
        ...
        <div class="panel container panel-default bg-body-secondary">
            <h4 class="panel-heading">Keterangan Karyawan</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="card-header card-title border-0">
                                            <div class="text-center">Keterangan
                                                - <?php echo $_SESSION['name'] ?> - Karyawan
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mt-1">
                                            <div class="form-inline row justify-content-center align-items-center">
                                                ...
                                                <div class="col-sm-6 col-md-7">
                                                    <input type="text" name="nip" required aria-required="TRUE" readonly
                                                        id="" value="<?php echo $pro['nip']?>" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group mt-1">
