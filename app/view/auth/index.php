...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="../auth/styles-min.css" crossorigin="anonymous">
        <?php 
            ...
            <div class="d-flex justify-content-center align-items-center flex-wrap mt-1 pt-1">
                <div class="card shadow mb-4">
                    <div class="card-header py-2">
                        <h4 class="card-title text-center">Login - Karyawan -</h4>
                    </div>
                    <div class="card-body">
                        <?php 
                            ...
                            /* Files and Contrller */
                            $user = new model\people($konfigs);
                            $auth = new controller\karyawan($konfigs);
                            if(!isset($_GET['aksi'])){
                            }else{
                                switch ($_GET['aksi']) {
                                    case 'login':
